...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="250" align="left" valign="top"><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td><a class="hesabimlink" href="cocuk-giyim" style="text-decoration: none; <?php if($gelenmenuid==""){ ?>color: #FF9900;<? }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler (<?php echo $tumurunlersayisikaydi["toplamurunsayisi"]; ?>) </a></td>
					</tr>
					<?php
					...
					foreach($MenuKayitlari as $Menu){
						?>
						<tr height="30">
							<td><a class="hesabimlink" href="cocuk-giyim/menu/<?php echo $Menu["id"]; ?>" style="text-decoration: none; <?php if($gelenmenuid==$Menu["id"]){ ?>color: #FF9900;<? }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;<?php echo DonusumleriGeriDondur($Menu["menuadi"]); ?> (<?php echo DonusumleriGeriDondur($Menu["urunsayisi"]); ?>)</a></td>
						</tr>
						<?php
					}
					?>
		...
		<td width="795" align="left" valign="top"><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><div class="aramaalani"><form method="post" action="<?php if ($MenuKosulu!=""){ ?> cocuk-giyim/menu/<?php echo $Menu["id"]; ?> }else{ ?> cocuk-giyim <?php	} ?> ">
										...
										foreach($urunler as $urun){
											...
											<td width="191" valign="top">
												<table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- border: 1px solid #CCCCCC; -->
													<tr height="40">
														<td align="center"><a href="cocuk-giyim/<?php echo SEO(DonusumleriGeriDondur($urun["urunadi"])); ?>/<?php echo DonusumleriGeriDondur($urun["id"]); ?>"><img src="Resimler/UrunResimleri/Cocuk/<?php echo DonusumleriGeriDondur($urun["resimbir"]); ?>" border="0" width="180" height="240"></a></td>
													</tr>
													<tr height="25">
														<td width="191" align="center"><a href="cocuk-giyim/<?php echo SEO(DonusumleriGeriDondur($urun["urunadi"])); ?>/<?php echo DonusumleriGeriDondur($urun["id"]); ?>" style="color: #FF9900; font-weight: bold; text-decoration: none;">Çocuk Ayakkabısı</a></td>
													</tr>
													<tr height="25">
														<td width="191" align="center"><a href="cocuk-giyim/<?php echo SEO(DonusumleriGeriDondur($urun["urunadi"])); ?>/<?php echo DonusumleriGeriDondur($urun["id"]); ?>" style="color: black; text-decoration: none;"><div style="width: 191px; max-width: 191px; height: 28px; overflow: hidden; line-height: 14px;"><?php echo DonusumleriGeriDondur($urun["urunadi"]); ?></div></a></td>
													</tr>
													<tr height="25">
														<td width="191" align="center"><a href="cocuk-giyim/<?php echo SEO(DonusumleriGeriDondur($urun["urunadi"])); ?>/<?php echo DonusumleriGeriDondur($urun["id"]); ?>" style="color: #646464; text-decoration: none;"><div><img src="Resimler/<?php echo $puanresmi; ?>" border="0"></div></a></td>
													</tr>
													<tr height="25">
								...
								<tr height="50">
									<td align="center"><div class="sayfalamaalanikapsayici">
										...
										<div class="numaraalanikapsayici">
											<?php
											if($sayfalama>1){
												echo "<span class='sayfalamapasif'><a href='cocuk-giyim" . $SayfalamaKosulu . "/page/1'><<</a></span>";
												$SayfalamaIcinSayfaDegeriniBirGeriAl	=	$sayfalama-1;
												echo "<span class='sayfalamapasif'><a href='cocuk-giyim" . $SayfalamaKosulu . "/page/" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
											}
											for($SayfalamaIcinSayfaIndexDegeri=$sayfalama-$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri<=$sayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++){
												if(($SayfalamaIcinSayfaIndexDegeri>0) and ($SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi)){
													if($sayfalama==$SayfalamaIcinSayfaIndexDegeri){
														...
														echo "<span class='sayfalamapasif'><a href='cocuk-giyim" . $SayfalamaKosulu . "/page/" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
													}
												}
											}
											if($sayfalama!=$BulunanSayfaSayisi){
												$SayfalamaIcinSayfaDegeriniBirIleriAl	=	$sayfalama+1;
												echo "<span class='sayfalamapasif'><a href='cocuk-giyim" . $SayfalamaKosulu . "/page/" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
												echo "<span class='sayfalamapasif'><a href='cocuk-giyim" . $SayfalamaKosulu . "/page/" . $BulunanSayfaSayisi . "'>>></a></span>";
											}
											?>
										</div>
									</div></td>
