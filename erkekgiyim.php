...
<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="250" align="left" valign="top"><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td><a class="hesabimlink" href="index.php?SK=83" style="text-decoration: none; <?php if($gelenmenuid==""){ ?>color: #FF9900;<? }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler (<?php echo $tumurunlersayisikaydi["toplamurunsayisi"]; ?>) </a></td>
					</tr>
					<?php
		...
		<td width="795" align="left" valign="top"><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><div class="aramaalani"><form method="post" action="<?php if ($MenuKosulu!=""){ ?> index.php?SK=83&menuid=<?php echo $gelenmenuid; }else{ ?> index.php?SK=83 <?php	} ?> ">
									...
									if ($UrunSayisi>0) {
										foreach($urunler as $urun){
											...
											<td width="191" valign="top">
												...
												<tr height="40">
												<td align="center"><a href="index.php?SK=82&id=<?php echo DonusumleriGeriDondur($urun["id"]); ?>"><img src="Resimler/UrunResimleri/Erkek/<?php echo DonusumleriGeriDondur($urun["resimbir"]); ?>" border="0" width="180" height="240"></a></td>
												</tr>
												<tr height="25">
