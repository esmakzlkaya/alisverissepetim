...
if(isset($_SESSION["kullanici"])){
	...
	if (($gelenkargosecimi!="")and($gelenadressecimi!="")) {
		...
		if ($kargoadresguncellekontrol>0) {
				...
				<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="800" valign="top"><table  width="800" align="center" border="0" cellspacing="0" cellpadding="0">
								...
								<td><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="390" align="right"><table width="390" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
											...
											<tr>
												<td align="center"><input type="radio" name="odemeturusecimi" value="Havale" onClick="$.havalesecildi();"></td>
											</tr>
										</table></td>
									</tr>
								</table></td>
								...
								<td><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="192"><table width="192" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
											...
											<tr height="40">
												<td align="center">&nbsp;<img height="" src="Resimler/OdemeSecimiAxessCard.png" checked="checked"></td>
											</tr>
											<tr>
												<td>&nbsp;</td>
											</tr>
							...
							<tr class="KKalanlari">
								<td><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
									...
									<tr height=30>
										<td width="25" align="left" style="border-bottom: 1px solid #CCCCCC; color: black;"><input type="radio" name="taksitsecimi" value="1"></td>
						...
						<td width="250"  valign="top"><table width="250" align="center" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td colspan="2"><div class="sepeticidevametvealisverisitamamlabutonu">
									<a href="index.php?SK=98" style="font-size: 18px;font-weight: bold;text-decoration: none; color: white;"><img style="margin-top: 5px;" src="Resimler/SepetBeyaz21x20.png" border="0"> ÖDEME YAP </a>
								</div></td>
							</tr>
						</table></td>
					</tr>
