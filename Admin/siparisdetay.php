...
if (isset($_SESSION["yonetici"])) {
	...
	<table width="760" align="center"  border="0" cellpadding="0" cellspacing="0">
		<tr height="70">
			<td align="left" width="560" bgcolor="#001d26" align="center" height="100" style="color: #FF0000;"><h3>&nbsp;SİPARİŞ DETAY</h3></td>
			<td align="right" width="200" bgcolor="#001d26" align="center" height="100" style="color: #FF0000;"><a href="index.php?SKD=0&SKI=106" style="text-decoration: none; color: white;">Bekleyen Siparişlere Dön&nbsp;</a></td>
		</tr>
		<tr height="10">
						...
						if ($donguSayisi==0) {
							...
							<tr height="30">
								<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="100" style="color: black;" ><b>Adı Soyadı</b></td>
										<td width="10" style="color: black;" ><b> : </b></td>
										<td width="640" style="color: black;" ><?php echo DonusumleriGeriDondur($siparisler["adresadsoyad"]); ?></td>
									</tr>
								</table></td>
							</tr>
							<tr height="30">
								<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="100" style="color: black;" ><b>Telefon</b></td>
										<td width="10" style="color: black;" ><b> : </b></td>
										<td width="640" style="color: black;" ><?php echo DonusumleriGeriDondur($siparisler["adrestelno"]); ?></td>
									</tr>
								</table></td>
							</tr>
							<tr height="30">
								<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="100" style="color: black;" ><b>Adres</b></td>
										<td width="10" style="color: black;" ><b> : </b></td>
										<td width="640" style="color: black;" ><?php echo DonusumleriGeriDondur($siparisler["adresdetay"]); ?></td>
									</tr>
								</table></td>
							</tr>	
							<tr>
							...
							<td colspan="3">
								<table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="10" style="color: black;" ><b> : </b></td>
										<td width="590" style="color: black;" >&nbsp;<input type="text" name="gonderikodu" class="inputAlanlari"></td>
									</tr>
								</table></td>
							</tr>
							<tr height="40">
								<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="100" style="color: black;" >&nbsp;</td>
										<td width="10" style="color: black;" >&nbsp;</td>
										<td width="640" style="color: black;" ><input type="submit" value="Gönderi Kodunu İşle ve Siparişi Tamamla" class="yesilbuton"></td>
									</tr>
								</table></td>
							</tr>	
						</table>
