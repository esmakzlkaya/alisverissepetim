...
if (isset($_SESSION["yonetici"])) {
	...
	$ToplamKayitSayisiSorgusu				=	$DBConnection->prepare("SELECT * FROM uyeler WHERE silinmedurumu = '0' $aramakosulu ORDER BY id DESC");
	...
	<table width="760" align="center"  border="0" cellpadding="0" cellspacing="0">
		<tr height="70">
			...
			<td align="right" width="200" bgcolor="#001d26" align="center" height="100" style="color: #FF0000;"><a href="index.php?SKD=0&SKI=83" style="text-decoration: none; color: white;">SİLİNMİŞ ÜYELER&nbsp;</a></td>
		</tr>
		<tr height="10">
		...
		$uyelerSorgusu=$DBConnection->prepare("SELECT * FROM uyeler WHERE silinmedurumu = '0' $aramakosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
					...
					<td colspan="2" width="750" align="right"  valign="top" style="border-bottom: 1px solid #FF0000;"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td colspan="9"><table width="95" border="0" align="right" cellspacing="0" cellpadding="0">
								<tr>
									<td align="right" width="25"><a href="index.php?SKD=0&SKI=84&id=<?php echo DonusumleriGeriDondur($uyeid); ?>"><img style="margin-top: 5px;" src="../Resimler/Sil20x20.png" border="0"></a></td>
									<td align="right" width="30"><a href="index.php?SKD=0&SKI=84&id=<?php echo DonusumleriGeriDondur($uyeid); ?>" style="color:  #FF0000; text-decoration: none;">Sil</a></td>
				...
				<tr height="50">
					<td colspan="2" align="center"><div class="sayfalamaalanikapsayici">
						...
						<div class="numaraalanikapsayici">
							<?php
							if($sayfalama>1){
								echo "<span class='sayfalamapasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&page=1'><<</a></span>";
								$SayfalamaIcinSayfaDegeriniBirGeriAl	=	$sayfalama-1;
								echo "<span class='sayfalamapasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
							}
							for($SayfalamaIcinSayfaIndexDegeri=$sayfalama-$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri<=$sayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++){
								if(($SayfalamaIcinSayfaIndexDegeri>0) and ($SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi)){
									if($sayfalama==$SayfalamaIcinSayfaIndexDegeri){
										...
										echo "<span class='sayfalamapasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
									}
								}
							}
							if($sayfalama!=$BulunanSayfaSayisi){
								$SayfalamaIcinSayfaDegeriniBirIleriAl	=	$sayfalama+1;
								echo "<span class='sayfalamapasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
								echo "<span class='sayfalamapasif'><a href='index.php?SKD=0&SKI=82" . $SayfalamaKosulu . "&page=" . $BulunanSayfaSayisi . "'>>></a></span>";
							}
							?>
						</div>
					</div></td>
