		...
		<table width="760" height="100%" align="center" bgcolor="#001d26" border="0" cellpadding="0" cellspacing="0">
			...
			if($kargosayisi>0){
				foreach ($kargokayitlari as $kargo) {
					...
					?>
					<tr height="50" bgcolor="#001d26" valign="top">
						<td colspan="2" width="750" align="right" bgcolor="#001d26" valign="top" style="border-bottom: 1px solid #FF0000;"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
							<tr height="50" style="border: solid 1px white;">
								...
								<td align="left" width="150" style="color: white;"><b>Kargo Firması Adı</b></td>
								<td align="left" width="20"  style="color: white;" >:</td>
								<td align="left" width="200"  style="color: white;" ><?php echo DonusumleriGeriDondur($kargofirmasiadi); ?></td>
								<td align="left" width="10">&nbsp;</td>
								...
								<td align="left" width="70"><a href="index.php?SKD=0&SKI=26&id=<?php echo DonusumleriGeriDondur($kargoid); ?>"  style="color: white; text-decoration: none;">Güncelle</a></td>
								...
								<td align="left" width="30"><a href="index.php?SKD=0&SKI=30&id=<?php echo DonusumleriGeriDondur($kargoid); ?>" style="color: white; text-decoration: none;">Sil</a></td>
				...
				?>
				<tr height="50">
					<td colspan="" style="border: solid 1px #F50000; color: white;">Kargo firması bulunmamaktadır. </td>
				</tr>
				<?php
			}
			?>
