...
if (isset($_SESSION["yonetici"])) {
	...
	<table width="760" height="100%" align="center"  border="0" cellpadding="0" cellspacing="0">
		...
		if($bankahesapsayisi>0){
								...
								<tr height="60">
									<td align="center"><table width="150" align="right" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td width="100" valign="top"><a href="index.php?SKD=0&SKI=14&id=<?php echo DonusumleriGeriDondur($bankaid); ?>"  style="color: #0000FF; text-decoration: none;">Güncelle</a></td>
											...
											<td width="40" valign="top"><a href="index.php?SKD=0&SKI=18&id=<?php echo DonusumleriGeriDondur($bankaid); ?>" style="color:  #FF0000; text-decoration: none;">Sil</a></td>
										</tr>
									</table></td>
								</tr>
							</table></td>
							<td width="10" >&nbsp;</td>
							<td height="90" width="590" align="right" valign="top"><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
								<tr>
										...
										<tr>
											<td width="590"><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
												<tr height="40" style="border: solid 1px white;">
													<td width="110" style="color: black;"><b>Banka Adı</b></td>
													<td width="20"  style="color: black;" >:</td>
													<td width="150"  style="color: black;" ><?php echo DonusumleriGeriDondur($bankaadi); ?></td>
													<td width="130"  style="color: black;" ><b>Hesap Sahibi</b></td>
													<td width="20"  style="color: black;" >:</td>
													<td width="170"  style="color: black;" ><?php echo DonusumleriGeriDondur($hesapsahibi); ?></td>
												</tr>
											</table></td>
										</tr>
									</table></td>
								...
								<tr>
									<td><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="590"><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
												<tr height="40" style="border: solid 1px white;">
													<td width="185" style="color: black;"><b>Şube ve Konum Bilgileri</b></td>
													<td width="20"  style="color: black;" >:</td>
													<td width="385"  style="color: black;" ><?php echo DonusumleriGeriDondur($subeadi); ?> (<?php echo DonusumleriGeriDondur($subekodu); ?>) - <?php echo DonusumleriGeriDondur($konumsehir); ?> - <?php echo DonusumleriGeriDondur($konumulke); ?></td>
												</tr>
											</table></td>
										</tr>
									</table></td>
								...
								<tr>
									<td><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="590"><table width="590" align="right" border="0" cellpadding="0" cellspacing="0">
												<tr height="40" style="border: solid 1px white;">
													<td width="130"  style="color: black;" ><b>Hesap Bilgileri</b></td>
													<td width="15"  style="color: black;" >:</td>
													<td width="435"  style="color: black;" ><?php echo DonusumleriGeriDondur($parabirimi); ?> / <?php echo DonusumleriGeriDondur($hesapno); ?> / <?php echo DonusumleriGeriDondur($ibanno); ?></td>	
												</tr>
											</table></td>
										</tr>
									</table></td>
			...
			?>
			<tr height="50">
				<td colspan="" style="border: solid 1px #F50000; color: black;">Banka hesabı bulunmamaktadır. </td>
			</tr>
			<?php
		}
		?>
